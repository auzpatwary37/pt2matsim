 ...
 */
public class InvertedLeastPathCalculator implements LeastCostPathCalculator {
    ...
    public Network getInvertedNetwork() {
		return invertedNetwork;
	}


	public void setInvertedNetwork(Network invertedNetwork) {
     ...
     */
    public static InvertedLeastPathCalculator create(LeastCostPathCalculatorFactory costFactory, TravelDisutilityFactory travelTimeFactory,
        ...
        InvertedLeastPathCalculator lpc =  new InvertedLeastPathCalculator(network, costFactory.createPathCalculator(invertedNetwork, travelCost, invertedTravelTimes));
        lpc.setInvertedNetwork(invertedNetwork);
        return lpc;
    }
